...
//
{
   ...
   double spot =  0.0;
     ...
     if (MOLECINCAGE)
     {
//           cout<<" calculate molecule in a  cage potential pimc 1376  "<<MCAtom[type0].type<<endl;//YULIA
              double com_1[3];
              double Eulang_1[3];
              double E_H2OC60;
...
/*                ofstream myfile;
                myfile.open ("exampleH2OC60.txt", ios :: app);
                myfile <<t0<<" "<<com_1[0]<<" "<<com_1[1]<<" "<<com_1[2]<<" | " \
                << Eulang_1[0]<<" "<<Eulang_1[1]<<" "<<Eulang_1[2]<<" | "<<E_H2OC60<<endl;
                myfile.close();
*/
              spot_pair += E_H2OC60;
         }//endloop over it (time slices)
      spot +=spot_pair;
      }//endif MOLECINCAGE
     else
     {
...
//
{
   ...
   double spot = 0.0;
       ...
       if (MOLECINCAGE)
       {
           ...
           calengy_(com_1, &E_H2OC60, Eulang_1);
/*                ofstream myfile;
                myfile.open ("exampleH2OC602.txt", ios :: app);
                myfile <<t0<<" "<<com_1[0]<<" "<<com_1[1]<<" "<<com_1[2]<<" | " \
                << Eulang_1[0]<<" "<<Eulang_1[1]<<" "<<Eulang_1[2]<<" | "<<E_H2OC60<<endl;
                myfile.close();
*/
